...
-- id=29 (Saving parent)
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, 'Saving Deposit', '/products/savings', 0);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, 'Normal Saving Account', '/products/savings/normal-saving-account', 1);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, "Investor's Saving Account", '/products/savings/investor-saving-account', 2);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, 'Special Saving Account', '/products/savings/special-saving-account', 3);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, 'Student Saving Account', '/products/savings/student-saving-account', 4);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, "Shareholder's Saving Account", '/products/savings/shareholder-saving-account', 5);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, 'PWD Saving Account', '/products/savings/pwd-saving-account', 6);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, 'Dhaulagiri Saving Account', '/products/savings/dhaulagiri-saving-account', 7);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, 'Kanchanjunga Saving Account', '/products/savings/kanchanjunga-saving-account', 8);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, 'Everest Saving Account', '/products/savings/everest-saving-account', 9);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, 'Super Saving Account', '/products/savings/super-saving-account', 10);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, 'Gold Saving Account', '/products/savings/gold-saving-account', 11);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, 'Diamond Saving Account', '/products/savings/diamond-saving-account', 12);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 29, 'Sarathi Saving Account', '/products/savings/sarathi-saving-account', 13);
...
-- id=44 (Fixed parent)
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 44, 'Fixed Deposit', '/products/fixed-deposits', 0);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 44, 'Individual Fixed Deposit', '/products/fixed-deposits/individual-fixed-deposit', 1);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 44, 'Corporate Fixed Deposit', '/products/fixed-deposits/corporate-fixed-deposit', 2);
...
-- id=48 (Loan parent)
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 48, 'Agricultural Loan', '/products/loans/agricultural-loan', 0);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 48, 'Auto Loan', '/products/loans/auto-loan', 1);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 48, 'Hire Purchase Loan', '/products/loans/hire-purchase-loan', 2);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 48, 'Education Loan', '/products/loans/education-loan', 3);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 48, 'Share Loan', '/products/loans/share-loan', 4);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 48, 'Home Loan', '/products/loans/home-loan', 5);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 48, 'FD Loan', '/products/loans/fd-loan', 6);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 48, 'Personal Loan', '/products/loans/personal-loan', 7);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 48, 'Business Loan', '/products/loans/business-loan', 8);
...
-- id=58 (Tools parent)
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 58, 'Compare Products', '/products/compare', 0);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 58, 'All Calculators', '/calculators', 1);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 58, 'Loan Eligibility', '/loan-eligibility', 2);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 58, 'EMI Calculator', '/emi-calculator', 3);
...
-- id=68 (Notice parent)
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 68, 'AGM Notice', '/publications/notices/agm-notice', 0);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 68, 'Dividend Declaration', '/publications/notices/dividend-declaration', 1);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 68, 'Unclaimed Dividend', '/publications/notices/unclaimed-dividend', 2);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 68, 'Right to Information', '/publications/notices/right-to-information', 3);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 68, 'Subsidy Loan List', '/publications/notices/subsidy-loan-list', 4);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 68, 'Tender Notice', '/publications/notices/tender-notice', 5);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 68, 'General Notice', '/publications/notices/general-notice', 6);
...
-- id=78 (Report parent)
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 78, 'AGM Minute', '/publications/reports/agm-minute', 0);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 78, 'Annual Report', '/publications/reports/annual-report', 1);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 78, 'Quarterly Reports', '/publications/reports/quarterly-reports', 2);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 78, 'Basel II Disclosure', '/publications/reports/basel-ii-disclosure', 3);
INSERT INTO navigation_items (navigation_id, parent_id, label, href, sort_order) VALUES (1, 78, 'SEBON Report', '/publications/reports/sebon-report', 4);

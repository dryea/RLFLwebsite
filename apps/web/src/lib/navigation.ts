...
export const mainNav: NavItem[] = [
  { label: "Home", labelNp: "गृहपृष्ठ", href: "/" },
  {
    ...
    children: [
      { label: "Who We Are", labelNp: "हामी को हौं", href: "/about/introduction" },
      ...
      { label: "Department Heads", labelNp: "विभाग प्रमुखहरू", href: "/team/head-of-department" },
    ],
  },
  {
    label: "Products", labelNp: "उत्पादनहरू", href: "/products",
    children: [
      { label: "Deposits", labelNp: "निक्षेप", href: "/products/savings",
        children: [
      ...
      { label: "Loans", labelNp: "ऋण सेवाहरू", href: "/products/loans",
        children: [
      ...
      { label: "Calculators & Tools", labelNp: "क्याल्कुलेटर र उपकरणहरू", href: "/calculators",
        children: [
...
export const footerAboutLinks = {
  ...
  links: [
    { en: "Who We Are", np: "हामी को हौं", href: "/about/introduction" },
    ...
    { en: "Department Heads", np: "विभाग प्रमुखहरू", href: "/team/head-of-department" },
  ],
};
